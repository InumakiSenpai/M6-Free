...
def predict():
    if request.method == 'POST':
        ...
        probabilities = loaded_model.predict(np.array([[age, gen, hours, country]]))
        ...
        return render_template('/prediction.html', prediction=prediction_label, runtime=runtimes)
